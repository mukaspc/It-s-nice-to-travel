 ...
 */
export const HeroSection: React.FC<HeroSectionProps> = ({ heroContent, onCTAClick, authState }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            <span className="text-blue-600">Plan</span> <span className="text-emerald-600">trips</span>{" "}
            <span className="block sm:inline">with AI</span>
          </h1>

          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">{ctaContent.description}</p>
